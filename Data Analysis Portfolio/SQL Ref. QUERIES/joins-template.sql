-- Create 2 new tables, departments and employees and insert values into table
...
-- Joining employees and departments together using dept_id value

SELECT *
FROM employees JOIN departments
ON employees.dept_id = departments.dept_id;

-- Create two new tables schools_left and schools_right and join them together
